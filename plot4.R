...
par(mfrow=c(2,2))
plot(datetime, epc$Global_active_power , type="l", main="", ylab="Global Active Power", xlab="")
plot(datetime, epc$Voltage, type="l", main="", ylab="Voltage")
...
legend("topright", colnames(epc)[7:9], col=c("black", "red", "blue"), lty=1, bty="n")
plot(datetime, epc$Global_reactive_power, type="l", main="", ylab="Global_reactive_power")
